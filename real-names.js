...
RealNamesGroups.push(
	...
	nameSets: [
		...
		splitters: [splitterAfter, splitterBefore],
		filters: standardFilters,
		names: ["Aman","Andustar","Anfalas","Angle","Angmar","Anórien","Araman","Arandor","Arda","Arnach","Arnor","Arthedain","Arthórien","Arvernien","Avathar","Beleriand","Belfalas","Calenardhon","Cardolan","Cormallen","Cuiviénen","Deldúwath","Dimbar","Dol Amroth","Dor Caranthir","Dor Daedeloth","Dor Dínen","Dor Firn-i-Guinar","Dor-Cúarthol","Dor-en-Ernil","Dor-lómin","Dor-nu-Fauglith","Doriath","Dorthonion","Dorwinion","Drúwaith Iaur","Dunland","Dwimordene","Egladil","Eglador","Eldamar","Elendë","Elenna·nórë","Emerië","Endor","Endóre","Enedwaith","Ennor","Ennorath","Eregion","Eriador","Estolad","Ethir","Evendim","Evereven","Faerie","Falas","Farthings","Fenmarch","Forlindon","Forodwaith","Forostar","Gondor","Haerast","Harad","Haradwaith","Harlindon","Harondor","Hildórien","Himlad","Hithlum","Hollin","Hyarastorni","Hyarnustar","Hyarrostar","Hísilómë","Imladris","Imloth Melui","Inlands","Ithilien","Khand","Ladros","Lamedon","Lammoth","Langstrand","Laurelindórenan","Lebennin","Lindon","Lindórinand","Lisgardh","Losgar","Lossarnach","Lothlórien","Lórien","Lórinand","Minhiriath","Mithrim","Mordor","Naith","Nan-tasarion","Nan-tathren","Nevrast","Nevrast","Norland","Nurn","Nísimaldar","Númenór","Númenórë","Oiomúrë","Orrostar","Ossiriand","Rhovanion","Rhudaur","Rhûn","Rivendell","Rochan","Rochand","Rochann","Rohan","Tasarinan","Thargelion","Umbar","Umbar","Valinor","Yôzâyan",
		       ]
	    },
